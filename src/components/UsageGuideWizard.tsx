...
const UsageGuideWizard: React.FC<UsageGuideWizardProps> = ({ lang, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-[#0B0D17]/95 backdrop-blur-xl animate-fade-in" onClick={onClose}>
            
            {/* Main Container */}
            <div 
                className="w-full max-w-6xl aspect-video md:aspect-[2/1] bg-[#15192B] rounded-[3rem] border border-white/5 shadow-2xl overflow-hidden relative flex flex-col md:flex-row"
            ...
            >
                ...
                {/* Left: Visual Section */}
                <div className="w-full md:w-1/2 relative bg-gradient-to-br from-blue-900/20 to-indigo-900/20 overflow-hidden flex items-center justify-center">
                    {/* Decorative Elements */}
                    ...
                    <img 
                      ...
                      alt="Telescope Step"
                      className="relative z-10 w-[80%] max-h-[80%] object-contain drop-shadow-[0_20px_50px_rgba(0,0,0,0.5)] animate-float"
                    />
                ...
                <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center relative">
                    ...
                    {/* Tip Box */}
                    {steps[step].note && (
                        <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-2xl p-6 flex gap-4 items-start mb-8">
                    ...
                    <div className="mt-auto flex gap-4 pt-4">
                        <button 
                            onClick={prevStep}
                            disabled={step === 0}
                            className={`px-8 py-4 rounded-2xl font-bold transition-all border border-white/10 ${
                                step === 0 
                        ...
                        <button 
                            ...
                            className="flex-1 px-8 py-4 rounded-2xl bg-cyan-500 text-black font-black text-lg hover:bg-cyan-400 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-[0_0_20px_rgba(34,211,238,0.3)] flex items-center justify-center gap-3"
                        >
                            {step === totalSteps - 1 
